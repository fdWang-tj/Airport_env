...
class AirEnv(Env):
    def __init__(self):
        ...
        #wb_airtug数量以及已排序车辆
        self.wb_airtug_param['num']=15
        self.wb_airtug_param['ahead_num']=10
        ...
        self.water_service_param['num']=10
        self.water_service_param['ahead_num']=25
...
class FlattenDictWrapper(gym.Wrapper):  
    ...
    def step(self, action):   
        #action=action[0]
        na_action = action[0:10]  
        wa_action = action[10:25]
        ws_action = action[25:35]
